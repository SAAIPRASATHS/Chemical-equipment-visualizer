# Generated by Django 4.2.7 on 2026-02-03 06:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('current_dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trend_as_current', to='api.dataset')),
                ('previous_dataset', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='trend_as_previous', to='api.dataset')),
            ],
            options={
